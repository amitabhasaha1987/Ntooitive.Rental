...
{
    /// <summary>
    /// Summary description for OfficeImageUpload
    /// </summary>
    public class OfficeImageUpload : IHttpHandler
    {
        ...
        private void UploadFile(HttpContext context)
        {
            ...
            var headers = context.Request.Headers;
            var uniqueID = context.Request.Form["OfficeId"];
        ...
        // Upload entire file
        private void UploadWholeFile(HttpContext context, string uniqueId, List<UploadAgentFileStatus> statuses)
        {
            ...
            for (int i = 0; i < context.Request.Files.Count; i++)
            {
                ...
                var _office = NinjectConfig.Get<IOffice>();
                string a = _office.GetPreviousImageUrl(uniqueId);
                ImageDelete imgDelete = new ImageDelete();
                imgDelete.DeleteImage(a);
                _office.UploadProfileImage(uniqueId, url);
            }
        }
