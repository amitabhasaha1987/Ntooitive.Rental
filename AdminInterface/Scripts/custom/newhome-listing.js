...
*/
    ...
    oTable = $("#newhomelisting").dataTable({
        ...
        "bProcessing": true,
        "order": [[2, "asc"]],
        "sAjaxSource": '/property/newhome-listing-ajax-handler',
        "aoColumns": [
                    {
                        "bVisible": false,
                        "bSortable": false,
                    ...
                    },
                    {
                        ...
                        "mRender": function (data, type, full) {
                            return "<a class=\"btn btn-block btn-primary\" href=\"javascript:ManageProperty('" + full[0] + "');\">Manage</a>";
                        }
                    },
                    {
                        "bSortable": false,
                        "bSearchable": false,
                        "mRender": function (data, type, full) {
                            return "<a class=\"btn btn-block btn-danger\" href=\"javascript:DeleteProperty('" + full[0] + "');\">Delete</a>";
                        }
                    }
...
function ManageProperty(mlsid) {
    window.location.href = "/property/newhome/new-plan?planid=" + mlsid;
}

function DeleteProperty(mlsid) {
    $.ajax({
        url: "/property/delete-newhome?planId=" + mlsid,
        type: "POST",
